...
function NeverLose:RegisiterHandler(Handler: Frame , Signal)
	...
	function handle:AddToggle(Config)
        ...
        ToggleContainer.Name = NeverLose.RandomString();
        ToggleContainer.Parent = Handler
        ToggleContainer.BackgroundColor3 = Color3.fromRGB(10, 13, 21)
        ToggleContainer.BorderColor3 = Color3.fromRGB(0, 0, 0)
        ToggleContainer.BorderSizePixel = 0
        ToggleContainer.Size = UDim2.new(1, 0, 0, 50)
        ToggleContainer.ZIndex = ZINdex + 12
        ToggleContainer.LayoutOrder = -(#Handler:GetChildren() + 5);

        Toggle.Name = NeverLose.RandomString();
        Toggle.Parent = ToggleContainer
        Toggle.BackgroundColor3 = Color3.fromRGB(15, 18, 28)
        ...
        DescriptionLabel.AnchorPoint = Vector2.new(0, 0.5)
        DescriptionLabel.Size = UDim2.new(1, -50, 0, 20)
        DescriptionLabel.ZIndex = ZINdex + 13
        ...
        ToggleLib.SetUI = LPH_NO_VIRTUALIZE(function(value)
            if value then
                NeverLose.PlayAnimate(Toggle, SlowyTween, {
                    BackgroundColor3 = NeverLose.AccentColor or Color3.fromRGB(0, 255, 100),
                })
        ...
        ToggleLib.SetDescription = LPH_NO_VIRTUALIZE(function(text)
        ...
        NeverLose:CreateInput(ToggleContainer, LPH_NO_VIRTUALIZE(function()
