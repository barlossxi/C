...
NeverLose.LoadIcon = LPH_NO_VIRTUALIZE(function()
	local ok, Icons = pcall(function()
		return loadstring(game:HttpGet("https://gitlab.com/phantomreal1/chronohub/-/raw/main/icon.lua"))()
	end)

	NeverLose.RobloxIcon = ok and Icons or {};
end);

function NeverLose:GetIcon(a)
	if string.find(a, "rbxassetid://") then
		return a
	end

	local icon = NeverLose.RobloxIcon and NeverLose.RobloxIcon["lucide-" .. a]
	if icon then
		return icon
	end
...
function NeverLose:RegisiterItem(Frame: Frame , Signel)
	...
	function idx:AddButton(Config)
        ...
        if Config.Icon ~= nil then
            ...
            Icon.TextWrapped = true
            NeverLose:SetIconTarget(Icon, Config.Icon, Color3.fromRGB(223, 223, 223))
        end
        ...
        function Button:SetIcon(t)
            if Icon then
                NeverLose:SetIconTarget(Icon, t, Color3.fromRGB(223, 223, 223))
            end
        end;
...
function NeverLose:CreateWindow(Config)
	...
	function Window:AddTab(Config)
		...
		NeverLose:SetIconTarget(TabIcon, Config.Icon, NeverLose.AccentColor)
...
function NeverLose:CreateIndicator()
	...
	function Indicators.new(Config)
		...
		Icon.TextTransparency = 1
		Icon.TextWrapped = true
		NeverLose:SetIconTarget(Icon, Config.Icon, Color3.fromRGB(186, 186, 186))
